...
// Only for test
#include "algo/aliasresolution/AliasHintsCollector.h"
...
void printInfo()
{
    ...
    cout << "=======\n";
    cout << "\n";
    cout << "WISE (Wide and lInear Subnet inferencE) is a subnet inference tool that is\n";
    cout << "capable of detecting subnets within a target domain in a time proportional to\n";
    cout << "the amount of IPs that are responsive to probes in the same network. To\n";
    cout << "achieve this, WISE proceeds in three major algorithmic steps described below.\n";
    cout << "\n";
    ...
    cout << "------------------------------\n";
    cout << "\n";
    cout << "WISE parses its main argument to get a list of all the target IPs it should\n";
...
void printUsage()
{
    ...
    cout << "\n";
    cout << "./wise [target n°1],[target n°2],[...]\n";
    cout << "\n";
    ...
    cout << "\n";
    cout << "Use this option to feed a configuration file to WISE. Use such a file,\n";
    cout << "formatted as key=value pairs (one per line), to edit probing, concurrency or\n";
    cout << "algorithmic parameters.\n";
    cout << "\n";
    ...
    cout << "files. By default, it will use the time at which WISE first started to run,\n"; 
    ...
    cout << "=====\n";
    cout << "\n";
    cout << "WISE (Wide and lInear Subnet inferencE) is a subnet inference tool designed\n";
    cout << "and implemented by Jean-François Grailet (Ph. D. student at the University\n";
    cout << "of Liège).\n";
    cout << "\n";
...
int main(int argc, char *argv[])
{
    ...
    try
    {
         ...
         * inference itself, the tool makes a census of all IPs that will be identifying 
         * neighborhoods (i.e., IPs from direct trails towards pivot IPs of each subnet) then 
         * starts a short (partial) traceroute phase to collect additional data on the pivot 
         * interfaces within subnets, which will be later used to discover how neighborhoods are 
         * located w.r.t. each others, using the concept of "peers" (see the headers of the 
         * classes in the neighborhoods/ module).
         */
