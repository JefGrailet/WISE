...
private:
    ...
    /*
     * Expands the current hypothetical merged subnet, updating the "fusion..." variables in the 
     * process. Requires and returns nothing.
     */
     ...
     * @return MergingCandidate*       NULL if merging is out of question, otherwise a pointer to 
     *                                 a new MergingCandidate object keeping track of the 
