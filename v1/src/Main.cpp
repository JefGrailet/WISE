...
int main(int argc, char *argv[])
{
     ...
     * put it at the end. If not found, WISE stops and displays an error message.
     */
            ...
            switch(opt)
            {
                ...
                case 'v':
                    ...
                    else
                    {
                        ...
                        cout << "out of [0,3]) was provided. WISE will use the laconic ";
    ...
    try
    {
        ...
        prescanner = new TargetPrescanner(env);
