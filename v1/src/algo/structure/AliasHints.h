...
public:
    ...
    inline unsigned long *getProbeTokens() { return probeTokens; }
    inline unsigned short *getIPIdentifiers() { return IPIdentifiers; }
    inline bool *getEchoes() { return echoMask; }
