/*
 * This file implements the class described in DirectICMPPProber.h. Date at which it was 
 * implemented is unknown (though it should be the same as DirectICMPProber.h).
 */
